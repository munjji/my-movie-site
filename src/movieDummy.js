export const movies = { //다른 파일에서 import 해서 사용할 것이기 때문에 export
  "page": 1,
  "results": [
    {
      "adult": false,
      ...
      "overview": "1956년, 프랑스의 한 성당에서 신부가 끔찍하게 살해당한다. 이 사건을 조사하기 위해 파견된 아이린 수녀는 4년 전 자신을 공포에 떨게 했던 악마의 기운을 느낀다. ",
      "popularity": 4160.929,
    ...
    },
    {
      ...
      "popularity": 3761.779,
      "poster_path": "/roSRPsFUOF6PhYo43BFZsmpIiyP.jpg",
    ...
    },
    {
      ...
      "overview": "실시간트렌드 #90초빙의챌린지 #넘사벽스릴 #주작아님  STEP 1. 촛불을 켜고 저승의 문을 연다.  STEP 2. 몸을 묶고 ‘죽은 자의 손’을 잡는다.  STEP 3. “내게 말해”라고 속삭인다.  STEP 4. 나타난 귀신에게 “널 들여보낸다”라고 말하면 빙의 완료.  ※ 경고 ※ 단, 90초 안에 깨울 것. 반드시 촛불을 꺼 문을 닫을 것. SNS에서 핫한 빙의 챌린지에 중독된 '미아'와 친구들. ",
      "popularity": 2107.318,
    ...
    },
    {
      ...
      "overview": "주인공이 우연히 외계의 유물인 스캐럽을 접해 초인적인 힘을 가진 히어로 블루비틀이 되어 악당을 무찌르고 가족들을 구해낸다는 내용의 영화",
      "popularity": 1833.576,
      "poster_path": "/2Dk0mkkgjwCIJ7VMThFQP21g4gJ.jpg",
    ...
    },
    {
      ...
      "overview": "레이싱 게임 ‘그란 투리스모’의 덕후 ‘잔 마든보로’ 스피드라고는 게임으로만 만족해야 했던 그에게 레이싱 선수 발굴을 목표로 만들어진 ‘그란 투리스모 콘테스트’라는 기회가 찾아온다. 앉아서 게임만 하던 그의 앞에 닥친 혹독한 훈련과 치열한 경쟁.뛰어난 잠재력을 입증해 프로 레이싱 팀에 합류하는데 성공하지만 상대팀 선수들은 게이머 출신인 그를 인정하지 않고, 프로 레이싱의 세계는 그를 더욱 거칠게 몰아붙이는데...",
      "popularity": 2101.916,
    ...
    },
    {
      ...
      "overview": "망망대해에서 표류하는 컨테이너. 물이 새어 들어오는 이곳에서 한 여성이 식량 한 캔과 칼 한 자루만으로 생존을 위한 사투를 벌인다. 믿을 것은 오직 자신뿐.",
      "popularity": 2102.527,
    ...
    },
    {
      ...
      "overview": "모든 것을 잃은 트럭 레이서, 호제르. 절도를 일삼는 갱단의 화물 운반 운전사로 일해달라는 굉장히 솔깃하면서도 위험한 제안을 받는다.",
      "popularity": 1132.347,
      "poster_path": "/ocKoEvCPX809gWsyEXRP2zTViY5.jpg",
    ...
    },
    {
      ...
      "overview": "전 우주의 행성을 집어삼키는 절대자, ‘유니크론’의 부하 ‘스커지’는 ‘테러콘’들을 이끌고 지구에 당도한다. 그에 맞서기 위해 지구에 정체를 숨기고 있던 트랜스포머 ‘오토봇’ 군단이 모습을 드러내고 또 다른 트랜스포머 진영인 ‘맥시멀’과 힘을 합친다. ",
      "popularity": 736.153,
    ...
    },
    {
      ...
      "overview": "칼 프레드릭슨이 어느 부인과 뜻밖의 데이트를 하게 되자 그의 개인 더그가 친구를 사귀는 팁을 전수하는 내용",
      "popularity": 662.312,
      "poster_path": "/f495lR54ipbfnfP4Fu8zjz7hg3S.jpg",
    ...
    },
    {
      ...
      "overview": "납치 사건의 누명을 쓰고 죽은 아들. 홀로 남은 교회 집사 아버지는 자신의 손으로 정의를 바로 세우고, 아들의 결백을 증명하기 위해 부패한 경찰들과 싸운다.",
      "popularity": 570.759,
